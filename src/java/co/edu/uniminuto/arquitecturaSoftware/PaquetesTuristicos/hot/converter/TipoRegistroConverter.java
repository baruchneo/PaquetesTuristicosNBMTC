...
import co.edu.uniminuto.arquitecturaSoftware.PaquetesTuristicos.hot.sessions.TipoRegistroFacade;
...
@FacesConverter(value = "tipoRegistroConverter")
public class TipoRegistroConverter implements Converter {

    @Inject
    private TipoRegistroFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof TipoRegistro) {
            ...
            return getStringKey(o.getIdTipoRegistro());
        } else {
